...
export const questionResultList: QuestionResultDto[] = [
  {
    ...
    correct_answer: "서로소 유니온 타입 간 값은 일부 유니온 타입 변수에 할당",
    is_correct: false,
    explanation:
  ...
  },
  {
    ...
    correct_answer: ["정적 타입 검사 지원", "인터페이스와 제네릭을 지원함"],
    is_correct: true,
    explanation:
  ...
  },
  {
    ...
    point: 10,
    options: [],
    submitted_answer: ["정답1", "정답2"],
    correct_answer: ["정답1", "정답3"],
    is_correct: false,
    explanation: "",
  },
  {
